...
digit.fixed is used for selecting fixed landmarks that do not change from specimen to specimen. digitsurface can then be used to place equal spaced landmarks between those points to represent a surface, while digit.curve can be used to fit curves on the specimen (I haven't really figured out surface and curve yet)
